...
| -------- | -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| `bm25`   | Local Tantivy BM25 (`cyt-indexer-sdk`) | Default pipeline; fallback when rerank/llm fail or tool count is low                                                             | Local catalog scoring; no API keys. Fingerprints cached under `~/.config/cyt/cache/bm25/`.                                         |
