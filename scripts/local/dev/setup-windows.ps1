...
Write-Host '  scripts\pre-commit-hooks\prek-loop.cmd --short --one-run --changed-only --fail-fast -g py-dev'
Write-Host '  scripts\pre-commit-hooks\prek-loop-py-parallel.sh --short --one-run   # full Python, parallel unit shards + gherkin'
Write-Host '  scripts\pre-commit-hooks\prek-loop-py-parallel.sh --short --one-run --xdist   # parallel shards with pytest -n auto'
Write-Host '  scripts\pre-commit-hooks\prek-loop.cmd --short --one-run -g py         # pre-push gate'
Write-Host ''
